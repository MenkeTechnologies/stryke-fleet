...
|---|--------|------|----:|------------|
| 1 | `Fleet::Session` | `lib/Session.stk` | 18 | `open` · `send` · `send_line` · `send_secret` (transmit but redact) · `expect` · `branch` · `read` · `buffer` · `alive` · `eof` · `interact` · `close` · `transcript` · `events` · `matches` · `last_match` · `timed_out` · `transcript_text` |
